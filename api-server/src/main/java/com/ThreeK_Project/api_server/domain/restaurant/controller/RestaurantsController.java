...
public class RestaurantsController {
    ...
    @GetMapping("/search")
    public Page<RestaurantResponse> searchRestaurants(@ModelAttribute RestaurantSearch restaurantSearch,
                                                      @PageableDefault(size = 10) Pageable pageable) {
        return restaurantService.searchRestaurants(restaurantSearch, pageable);
    }
